...
(defn handle [ctx stroke]
  (m/match [stroke]
           ...
           [{:key :page-up}] (-> ctx (gc) (resize) (scroll-up) (deselect) (highlight) (parens-highlight) (re-render))
           [{:key :page-down}] (-> ctx (gc) (resize) (scroll-down) (deselect) (highlight) (parens-highlight) (re-render))
           [{:key :up :alt true}] (-> ctx (gc) (resize) (uncomplete) (roll-back) (highlight) (parens-highlight) (scroll-stop) (re-render))
           [{:key :down :alt true}] (-> ctx (gc) (resize) (uncomplete) (roll-forward) (highlight) (parens-highlight) (scroll-stop) (re-render))
           [{:key \l :ctrl true :alt true}] (-> ctx (resize) (reformat) (highlight) (scroll-stop) (parens-highlight) (opt-render))
           [{:key \r :ctrl true}] (-> ctx (gc) (resize) (clear) (uncomplete) (deselect) (highlight) (parens-highlight) (re-render))
           ...
           [_ :guard manipulation?] (-> ctx (gc) (resize) (uncomplete) (capture stroke) (calibrate) (highlight) (parens-highlight) (scroll-stop) (re-render))
           [_ :guard movement?] (-> ctx (gc) (resize) (uncomplete) (capture stroke) (calibrate) (highlight) (parens-highlight) (scroll-stop) (opt-render))
           :else (-> ctx (gc) (resize) (uncomplete) (capture stroke) (calibrate) (highlight) (parens-highlight) (scroll-stop) (diff-render))))

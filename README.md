...
# <img src="docs/images/omnia-logo.png" width="100" height="101"> mnia
 ...
 * Select code by means of incremental expansion
 ...
 ![selection-expansion](docs/images/expansion.gif)
...
and then pasting inside the REPL is not *currently* directly supported.
 ...
 ![copy-cut-paste](docs/images/copy-cut-paste.gif)

#### Undo/Redo
 * Undo actions and redo undoes
 
 ![undo-redo](docs/images/undo-redo.gif)

#### Scrolling
 * Scroll up and down the view arbitrarily
 * No mouse support for scrolling as of yet

 ![scrolling](docs/images/scrolling.gif)
 
#### Output clearing
 * Clear the output history
 
 ![clearing](docs/images/clearing.gif)
 ...
 * `retreive` currently only supports `clojars` and `mavencentral`
 ...
 ![dependency-resolution](docs/images/retrieval.gif)
 ...
 * Histories have a limit of 1000 evaluations
 ...
 ![repl-history](docs/images/history.gif)
